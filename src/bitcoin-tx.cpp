...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Logcoin Core logcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  logcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded logcoin transaction") + "\n" +
              "  logcoin-tx [options] -create [commands]   " + _("Create hex-encoded logcoin transaction") + "\n" +
              "\n";
